# Modal Share data
Modal share across metropolitan areas. The data contains the modal share distribution. The data has 3349 observations, corresponding to 1253 metropolitan areas. 
